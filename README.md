<h1 align="center">🕷️ nikhil@sharma ~ % whoami</h1>
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣤⣠⣴⠞⠛⢿⣿⣿⣿⣼⣿⣿⣿⣿⣿⣿⣿⣿⣯⣷⣿⣯⣾⣦⣤⣶⠦⠤⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀                      Builder / AI Systems
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡀⣶⣶⣶⣿⣿⣟⣻⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣧⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀   Company:           AI full stack engineer @huvo-ai, Ex Co-Founder @ Hi-Influence
...
> Bitten by a radioactive `npm install`, I gained the power to swing between frontend, backend, AI, and the blockchain — sticking to whatever stack the mission requires.

- 🎓 B.E. CSE (AI/ML), Chandigarh University
- 🚀 Co-Founder & Product Engineer at **Hi-Influence**, building AI content-generation systems at scale
- 🏆 Hackathon-tested builder — multiple wins and grants across Stacks, Hedera, ICP, and PayPal x Google Cloud Web3
- 🌐 [LinkedIn](https://www.linkedin.com/in/nikhhil07/) — for the days I wear the suit *without* the mask
- 📫 nikhhils07@gmail.com

---

### 🏆 Trophy Wall (Achievements & Awards)

- 🥇 **Winner — Best Gaming App**, Stacks Vibe Coding Hackathon ($5,000)
- 🥉 **3rd Place**, Hedera Hello Future Origins (Sustainability Track)
- 🌏 **Top 3 Regional Asia & Top 30 Global Finalist**, World Computer Hacker League (WCHL) by ICP
- 🎟️ **Grantee / Invited**, Stacks Hacker House, Buenos Aires
- 🏅 **Top 5 Finalist**, PayPal & Google Cloud Web3 Hackathon
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Hedera-000000?style=for-the-badge&logo=hedera&logoColor=white" />
...
### 🕷️ Cases from the Case Files (Key Projects)
